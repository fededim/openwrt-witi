...
define KernelPackage/crypto-hw-mtk-aes
  TITLE:=Mediatek aes engine
  DEPENDS:=+kmod-random-core +kmod-crypto-manager +crypto-ocf +kmod-crypto-cbc +kmod-crypto-ecb +kmod-crypto-rng
  KCONFIG:= \
	CONFIG_CRYPTO_DEV_MTK_AES
  FILES:=$(LINUX_DIR)/drivers/crypto/mtk-aes.ko
  AUTOLOAD:=$(call AutoLoad,09,mtk-aes)
  $(call AddDepends/crypto)
endef
