...
// This is the main function which writes a packet into cryptoEngine
static inline void
...

{
   ...
   HWPAL_DMAResource_Write32(
	...
	//Trey
	// This performs a dump of source packet which is being written into the cryptoEngine
	#if 0
	{
		uint32_t *Src_p;
...
#ifdef RT_EIP93_DRIVER_DEBUG_H
    // This performs a dump of all the information (packet + data structure) which is being written into the cryptoEngine
...
//#undef RT_EIP93_DRIVER_DEBUG_H //trey
    ...
    // padding words
    // this adds padding word to the standard 8 long packet (what's use ?!?)
